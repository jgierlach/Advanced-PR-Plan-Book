<template>
  <transition name="fade" appear>
    <div class="container">
      ...
      <p>
        Campus ministries has a rich history on Hope’s campus. Founded, in 1862
        Campus Ministries has found itself in 3 different phases.
        <strong>Campus Ministries 1.0:</strong> The Pioneer Season was the
        catalyst for many phases to come. People were planning what was going to
        become of Campus Ministries. The department was able to stake land which
        would now be referenced as the Keppel House.
      </p>
      ...
      <p>
        Campus Ministries rebuilt worship walls and created Chapel and The
        Gathering. This new vision was being formed of what Campus Ministries
